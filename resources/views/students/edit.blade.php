...
<div class="container">
    ...
    <div class="col-6" style="padding-bottom:50px">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control @error('kelamin') is-invalid @enderror" id="kelamin" placeholder="Masukan Jenis kelamin" name="kelamin" value="{{ $student->kelamin }}">
            @error('kelamin')
            <div class="invalid-feedback">{{ $message }}</div>
            @enderror
        </div>
        ...
        {{-- <div class="form-group">
            ...
            <input type="date" class="form-control" id="tempallahir" placeholder="Masukan Tanggal Lahir" name="tanggallahir">
        </div> --}}
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control @error('kelas') is-invalid @enderror" id="kelas" placeholder="Masukan Kelas" name="kelas" value="{{ $student->kelas }}">
            @error('kelas')
            <div class="invalid-feedback">{{ $message }}</div>
          @enderror
        </div>
